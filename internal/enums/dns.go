...
const (
	...
	PACKET_STREAM_KEEPALIVE                    = 0x13
	PACKET_STREAM_KEEPALIVE_ACK                = 0x14
	PACKET_STREAM_WINDOW_UPDATE                = 0x15
	PACKET_STREAM_WINDOW_UPDATE_ACK            = 0x16
	PACKET_STREAM_PROBE                        = 0x17
	PACKET_STREAM_PROBE_ACK                    = 0x18
	PACKET_SOCKS5_SYN                          = 0x19
	PACKET_SOCKS5_SYN_ACK                      = 0x1A
	PACKET_SOCKS5_CONNECT_FAIL                 = 0x1B
	PACKET_SOCKS5_CONNECT_FAIL_ACK             = 0x1C
	PACKET_SOCKS5_RULESET_DENIED               = 0x1D
	PACKET_SOCKS5_RULESET_DENIED_ACK           = 0x1E
	PACKET_SOCKS5_NETWORK_UNREACHABLE          = 0x1F
	PACKET_SOCKS5_NETWORK_UNREACHABLE_ACK      = 0x20
	PACKET_SOCKS5_HOST_UNREACHABLE             = 0x21
	PACKET_SOCKS5_HOST_UNREACHABLE_ACK         = 0x22
	PACKET_SOCKS5_CONNECTION_REFUSED           = 0x23
	PACKET_SOCKS5_CONNECTION_REFUSED_ACK       = 0x24
	PACKET_SOCKS5_TTL_EXPIRED                  = 0x25
	PACKET_SOCKS5_TTL_EXPIRED_ACK              = 0x26
	PACKET_SOCKS5_COMMAND_UNSUPPORTED          = 0x27
	PACKET_SOCKS5_COMMAND_UNSUPPORTED_ACK      = 0x28
	PACKET_SOCKS5_ADDRESS_TYPE_UNSUPPORTED     = 0x29
	PACKET_SOCKS5_ADDRESS_TYPE_UNSUPPORTED_ACK = 0x2A
	PACKET_SOCKS5_AUTH_FAILED                  = 0x2B
	PACKET_SOCKS5_AUTH_FAILED_ACK              = 0x2C
	PACKET_SOCKS5_UPSTREAM_UNAVAILABLE         = 0x2D
	PACKET_SOCKS5_UPSTREAM_UNAVAILABLE_ACK     = 0x2E
	PACKET_DNS_QUERY_REQ                       = 0x2F
	PACKET_DNS_QUERY_RES                       = 0x30
